        ...
        return json.dumps(
            {
                ...
                "sql_query": resolve_wkt_polygons(raw_sql, locations, mask=False),
        ...
        return json.dumps(
            {
                ...
                "status": "interrupted",
                "interrupt_details": interrupt_val,
                "sql_query": resolve_wkt_polygons(final_state.values.get("sql_query"), locations, mask=False),
                "trace_id": trace_id,
                "execution_path": final_state.values.get("execution_path", []),
            }
        )
    ...
    return json.dumps(
        {
            ...
            "sql_query": resolve_wkt_polygons(result.get("sql_query"), locations, mask=False),
