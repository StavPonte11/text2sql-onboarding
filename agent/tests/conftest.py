...
def mock_langfuse():
    ...
    with patch.object(agent.langfuse_client.langfuse_client, "get_current_trace_id", return_value="mock_trace_id", create=True), \
         patch.object(agent.langfuse_client.langfuse_client, "get_current_observation_id", return_value="mock_obs_id", create=True), \
         patch.object(agent.langfuse_client.langfuse_client, "trace", MagicMock(), create=True), \
         patch.object(agent.langfuse_client.langfuse_client, "span", MagicMock(), create=True), \
         patch.object(agent.langfuse_client.langfuse_client, "get_prompt", return_value=mock_prompt, create=True):
