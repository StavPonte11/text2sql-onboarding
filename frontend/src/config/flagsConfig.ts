export const FLAG_CATEGORIES: Record<string, string[]> = {
  Extraction: [
    'EXTRACTOR_MODEL', 'EXTRACTOR_TEMPERATURE', 'EXTRACTOR_TOP_K_TABLES', 'DEFAULT_TABLE_SCOPING_MODE',
  ],
  'Schema Explorer': [
    ...
    'SCHEMA_EXPLORER_MODEL', 'SCHEMA_TOP_K_JOINS',
  ],
  'Query Builder': ['QUERY_BUILDER_MODEL', 'QUERY_BUILDER_TEMPERATURE'],
  Refiner: ['MAX_REFINER_ITERATIONS', 'MAX_SCHEMA_REPLAN_ITERATIONS', 'REFINER_SCHEMA_CONTEXT_TABLES', 'REFINER_MODEL'],
  'Satisfaction Check': [
