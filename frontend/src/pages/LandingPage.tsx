    ...
    <div className="landing-layout">
      ...
      <main>
        ...
        <section className="hero">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="hero-subtitle">
              The production-ready Text-to-SQL layer for your enterprise. Connect your data, train the semantic layer, and give your teams instant answers with enterprise-grade governance and monitoring.
            </motion.p>
              ...
              <div className="mockup-body">
                ...
                >
                  <div className="sql-code">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="function">SUM</span>(mrr) <span className="keyword">AS</span> total_mrr<br/>
                    <span className="keyword">FROM</span> subscriptions<br/>
                    <span className="keyword">WHERE</span> quarter = <span className="string">'Q3'</span><br/>
                    <span className="keyword">GROUP BY</span> customer_name<br/>
                    <span className="keyword">ORDER BY</span> total_mrr <span className="keyword">DESC</span><br/>
                  ...
                  >
                    <LineChart size={18} className="text-primary" /> Query executed successfully in 45ms.
                  </motion.div>
                </motion.div>
              </div>
            </div>
        ...
        <section id="features" className="features-section">
          ...
          >
            {[
              { icon: Zap, title: "Instant Schema Sync", desc: "Automatically synchronize your database schemas, tables, and column metadata. Add descriptions to improve LLM accuracy." },
              { icon: Shield, title: "Enterprise Governance", desc: "Row-level security, query parsing, and malicious intent detection to ensure your data stays safe and secure." },
              { icon: Cpu, title: "Model Agnostic", desc: "Plug in OpenAI, Anthropic, Gemini, or host your own fine-tuned open-source models for ultimate flexibility and privacy." },
              { icon: Code2, title: "Developer SDKs", desc: "Integrate Text2SQL capabilities into your own products with our React, Python, and Node.js SDKs in minutes." }
            ].map((feat, i) => (
              <motion.div 
                key={i} 
