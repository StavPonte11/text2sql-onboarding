  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <button
          style={btnStyle(voted === 'positive', 'var(--status-production)')}
          onClick={() => {
            setVoted('positive');
            mutation.mutate('positive');
          }}
        ...
        <button
          style={btnStyle(voted === 'negative', 'var(--status-degraded)')}
          onClick={() => {
            setVoted('negative');
            setShowComment(true);
          }}
      ...
      {showComment && (
        ...
        >
          ...
          <button
            ...
            onClick={() => mutation.mutate(voted ?? 'negative')}
            disabled={mutation.isPending}
          >
