...
import type { EnrichmentData, GoldenQuestionCreate, Table, TableCreate } from '../../types';
...
export function OnboardingWizard() {
  ...
  const [enrichmentForm, setEnrichmentForm] = useState<EnrichmentData>({
    table_description: '',
    columns: [],
  });
  ...
  const canNext = () => {
    ...
    if (step === 'validate') {
      return (
        enrichmentForm.table_description.length >= 20 &&
  ...
  const addQuestion = () =>
    setQuestions((q) => [
      ...q,
      { question: '', expected_sql: '', difficulty: 'simple', question_type: 'simple' },
    ]);
    ...
    <div className="page">
      ...
      <div className="card" style={{ marginBottom: 24 }}>
          ...
          <div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={tableForm.oasis_source_id}
          ...
          <div>
            ...
            <div style={{ background: 'var(--bg-base)', borderRadius: 8, padding: 16 }}>
              <div style={{ fontWeight: 600, marginBottom: 8 }}>
                Table: <code>{createdTable?.name || tableForm.oasis_source_id}</code>
              </div>
          ...
          <div>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setEnrichmentForm((f) => ({ ...f, table_description: e.target.value }))
                }
            ...
            <div style={{ marginBottom: 10, display: 'flex', justifyContent: 'space-between' }}>
              ...
              <button
                ...
                onClick={() =>
                  setEnrichmentForm((f) => ({
                    ...f,
                    columns: [...f.columns, { name: '', description: '' }],
                  }))
                }
              >
                + Add Column
        ...
        {step === 'submit' && (
          <div style={{ textAlign: 'center', padding: '24px 0' }}>
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: 13 }}>
              Table <strong>{createdTable?.name || tableForm.oasis_source_id}</strong> with{' '}
              {enrichmentForm.columns.length} columns and {questions.length} golden questions.
            </div>
          </div>
        )}
      </div>
      ...
      <div className="flex gap-2" style={{ justifyContent: 'flex-end' }}>
        ...
        <button
          className="btn btn--primary"
          disabled={
            !canNext() || createTableMutation.isPending || createEnrichmentMutation.isPending
          }
          onClick={handleNext}
        >
