      ...
      <AreaChart data={formatted} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
        ...
        <Tooltip
          ...
          formatter={(value: number, name: string) => [
            `${value}%`,
            name === 'score_pct' ? 'Avg Score' : 'Pass Rate',
          ]}
        ...
        <ReferenceLine
          ...
          strokeDasharray="4 4"
          strokeOpacity={0.4}
          label={{ value: '90%', fill: '#10b981', fontSize: 10, position: 'right' }}
        />
        <ReferenceLine
          y={50}
          stroke="#f59e0b"
        ...
        />
        <Legend
          formatter={(n) => (n === 'score_pct' ? 'Avg Score' : 'Pass Rate')}
