...
export function MetricCard({
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        if (onClick) (e.currentTarget as HTMLDivElement).style.borderColor = 'var(--accent-glow)';
      }}
      onMouseLeave={(e) => {
        if (onClick) (e.currentTarget as HTMLDivElement).style.borderColor = 'var(--border)';
      }}
    >
